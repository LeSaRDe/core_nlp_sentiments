...
public class CoreNLPSentiments {
    ...
    private StanfordCoreNLP create_tokenizer() {
        ...
        tokenizerProps.setProperty("tokenize.options", "untokenizable=allDelete, splitHyphenated=false, americanize=false");
...
//    }
    ...
    public static void main(String[] args) {
        ...
        String test_sentence = "nice food";
        String sgraph_json_file_path = "sgraph_test.json";
        try {
